package com.h.cheng.chain100.statusbar;
...
public class UtilsStatusBar {
    ...
    public static void setStatusTextColor(boolean useDart, Activity activity) {
        if (isFlyme()) {
            ...
            activity.getWindow().getDecorView().findViewById(android.R.id.content).setPadding(0, 0, 0, UtilsStatusBar.navigationHeight);
        }
    }
}
