...
public class ProgressView extends View {
    ...
    public ProgressView(Context context, @Nullable AttributeSet attrs) {
        ...
        progressStartColor = ta.getColor(R.styleable.ProgressView_pr_progress_start_color, Color.YELLOW);
        progressEndColor = ta.getColor(R.styleable.ProgressView_pr_progress_end_color, progressStartColor);
        bgStartColor = ta.getColor(R.styleable.ProgressView_pr_bg_start_color, Color.LTGRAY);
        bgMidColor = ta.getColor(R.styleable.ProgressView_pr_bg_mid_color, bgStartColor);
        bgEndColor = ta.getColor(R.styleable.ProgressView_pr_bg_end_color, bgStartColor);
        progress = ta.getInt(R.styleable.ProgressView_pr_progress, 0);
        progressWidth = ta.getDimension(R.styleable.ProgressView_pr_progress_width, 8f);
        startAngle = ta.getInt(R.styleable.ProgressView_pr_start_angle, 120);
        sweepAngle = ta.getInt(R.styleable.ProgressView_pr_sweep_angle, 300);
        showAnim = ta.getBoolean(R.styleable.ProgressView_pr_show_anim, true);
        ta.recycle();
